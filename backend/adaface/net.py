...
def IR_50(input_size=(112, 112)):
    ...
    model = Backbone(num_layers=50, drop_ratio=0.4, mode='ir')
    return model


def IR_101(input_size=(112, 112)):
    """Constructs an IR-101 model."""
    model = Backbone(num_layers=100, drop_ratio=0.4, mode='ir')
    return model


def IR_152(input_size=(112, 112)):
    """Constructs an IR-152 model."""
    model = Backbone(num_layers=152, drop_ratio=0.4, mode='ir')
    return model


def IR_SE_50(input_size=(112, 112)):
    """Constructs an IR-SE-50 model."""
    model = Backbone(num_layers=50, drop_ratio=0.4, mode='ir_se')
    return model


def IR_SE_101(input_size=(112, 112)):
    """Constructs an IR-SE-101 model."""
    model = Backbone(num_layers=100, drop_ratio=0.4, mode='ir_se')
    return model


def IR_SE_152(input_size=(112, 112)):
    """Constructs an IR-SE-152 model."""
    model = Backbone(num_layers=152, drop_ratio=0.4, mode='ir_se')
    return model
